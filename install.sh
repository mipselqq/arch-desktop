...
CAT_BUILD="base-devel"
CAT_AUTH="libsecret"
CAT_DEV="git docker docker-compose openssh rustup nodejs npm neovim vim ripgrep visual-studio-code-bin tokei bat apidog-bin"
...
CAT_ALL="$CAT_DE $CAT_THEMING $CAT_UTILS $CAT_SHELL $CAT_BUILD $CAT_AUTH $CAT_DEV $CAT_FONTS\
	$CAT_DURABILITY $CAT_APPS $CAT_VIRT $CAT_ARCHIEVES $CAT_MEDIA $CAT_COMPAT $CAT_ANTIROSKOMZALUPA"
